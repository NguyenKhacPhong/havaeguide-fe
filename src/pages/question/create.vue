                    ...
                    <div class="content-left col-9">
                        <div class="content_inner card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn btn-primary" @click="ask">Đặt câu hỏi</button>
                            </div>
                        </div>
                    </div>
...
const error = ref("");
const onBaseUrl = ref(baseUrl);

async function ask() {
    try {
        const response = await axios.post(baseUrl + "/api/question/ask", question.value, config)
